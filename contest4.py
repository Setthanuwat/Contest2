...
checkpoint = ModelCheckpoint('fried_noodles_best8.h5', verbose=1, monitor='val_mean_absolute_error', save_best_only=True, mode='min')
...
# Test
model = load_model('fried_noodles_best8.h5')
